...
function unstable_createStaticHandler(routes) {
  ...
  async function queryImpl(request, location, matches, routeMatch) {
    ...
    try {
      if (validActionMethods.has(request.method)) {
        let result2 = await submit(request, matches, routeMatch || getTargetMatch(matches, location), routeMatch != null);
        return result2;
      }
  ...
  async function loadRouteData(request, matches, routeMatch, pendingActionError) {
    ...
    let results = await Promise.all([...matchesToLoad.map((match) => callLoaderOrAction(
      "loader",
      request,
      match,
      matches,
 ...
 * @license MIT
 */
//# sourceMappingURL=chunk-5HP2O3MX.js.map
